const Factors = ({ fitness_goal }: { fitness_goal: string }) => {
  // cardiovascular
  ...
  return (
    <div className="flex flex-col gap-6 w-full">
      <h3 className="text-xl font-semibold">Factors to lose weight</h3>
      ...
      <div className="flex flex-col gap-9 mt-6">
        <div className="flex gap-3 relative h-fit items-stretch">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p>
              Nutrition plays the most significant role in weight loss. About
              70% of your success in burning fat and losing weight can be
              attributed to the food you consume. Focus on creating a calorie
              deficit by consuming nutrient-dense, whole foods that are low in
              refined sugars and saturated fats. Emphasize a balanced diet rich
              in lean proteins, healthy fats, complex carbohydrates, and a
              variety of fruits and vegetables. Portion control and mindful
              eating are key components of a successful nutrition plan.
            </p>
          </div>
        </div>
        ...
        <div className="flex gap-3 relative h-fit items-stretch">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p>
              ...
              increasing your overall energy expenditure. Approximately 15% of
              weight loss success is attributed to exercise. Incorporate a mix
              of cardiovascular exercises, such as running, cycling, or
              swimming, with strength training exercises to build muscle mass.
            </p>
          </div>
        </div>
        ...
        <div className="flex gap-3 relative h-fit items-stretch">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p>
              ...
              hormones that impact appetite and metabolism. Approximately 10% of
